...
<head>
    ...
    <title>Iniciar sesión — Barber Brizu</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .form-inner { max-width: 420px; width: 100%; margin: 0 auto; }
        ...
        .tag-dot {
            ...
            background: var(--blue-400); display: inline-block; flex-shrink: 0;
        }
        ...
        .btn-outline-dark:hover { background: var(--paper-2); }

        /* ── Separador ── */
        .divider { display: flex; align-items: center; gap: 14px; margin: 28px 0 20px; }
        .divider-line { flex: 1; height: 1px; background: var(--rule); }
        .divider-o { font-size: 12px; color: var(--ink-mute); text-transform: uppercase; letter-spacing: 0.12em; }
        ...
        @media (max-width: 768px) {
            ...
            /* Info card: apilar en columna para que el botón no se comprima */
            .info-card {
                flex-direction: column;
                align-items: stretch;
                gap: 12px;
...
<div class="auth-page">
    ...
    <section class="form-panel">
        <div class="form-inner">
            ...
            <h1 style="font-size: 44px; font-weight: 600; letter-spacing: -0.025em; line-height: 1.05; margin: 16px 0 10px;">
            ...
            <form method="POST" action="{{ url('/login') }}" style="margin-top: 32px;">
                @csrf
                <div style="display: flex; flex-direction: column; gap: 16px;">
                    ...
                    <div class="input-group">
                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 10px; flex-wrap: wrap; gap: 8px;">
                            ...
                            <a href="#" style="font-size: 13px; color: var(--blue-600); font-weight: 500; text-decoration: underline; text-underline-offset: 3px;">
            ...
            <div class="info-card">
                <div>
                    <div style="font-size: 14px; font-weight: 600;">¿No tenés cuenta?</div>
                    <div style="font-size: 13px; color: var(--ink-mute); margin-top: 2px;">Registrate y reservá un turno.</div>
                </div>
                <a href="{{ route('register') }}" class="btn-outline-dark">Registrarme</a>
            </div>

            <p style="margin-top: 36px; font-size: 12px; color: var(--ink-mute); text-align: center;">
    ...
    <aside class="brand-panel">
        ...
        <div class="brand-middle">
            ...
            <h2 class="brand-h2">
                El corte que<br>
                <em style="font-style: italic; color: var(--blue-600);">estabas esperando.</em>
            </h2>
            <p class="brand-sub">
                Reservá en menos de un minuto. Sin llamadas, sin idas y vueltas por WhatsApp.
            </p>
        </div>
